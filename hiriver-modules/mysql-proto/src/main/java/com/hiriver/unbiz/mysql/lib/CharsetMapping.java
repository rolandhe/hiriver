...
public class CharsetMapping {
    ...
    private static final String COLLATION_NOT_DEFINED = "none";
...
//
    ...
    public  static  boolean isBinary(String charsetName){
        return MYSQL_CHARSET_NAME_binary.equals(charsetName);
    }

    private static class MysqlCharset {
    ...
    private  static  class Collation {
